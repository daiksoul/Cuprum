...
execute as @a[scores={cupr.use_swo=1..},nbt={SelectedItem:{tag:{cuprum:{copper:1b}}}}] at @s if data entity @s SelectedItem.tag.cuprum{charged:1b} run function cuprum:lightning/sword
