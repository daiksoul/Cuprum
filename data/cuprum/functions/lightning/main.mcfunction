...
execute as @a[scores={cupr.hit=1..}] at @s if data entity @s Inventory[{Slot:101b}].tag.cuprum{charged:1b} run function cuprum:lightning/armor/hit
execute as @a[scores={cupr.hit=1..}] at @s if data entity @s Inventory[{Slot:102b}].tag.cuprum{charged:1b} run function cuprum:lightning/armor/hit
execute as @a[scores={cupr.hit=1..}] at @s if data entity @s Inventory[{Slot:103b}].tag.cuprum{charged:1b} run function cuprum:lightning/armor/hit
execute as @a[scores={cupr.hit=1..}] at @s if data entity @s Inventory[{Slot:104b}].tag.cuprum{charged:1b} run function cuprum:lightning/armor/hit
