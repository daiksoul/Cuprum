...
execute unless data entity @e[tag=cuprum.rose_gold_sword,limit=1,sort=nearest] HandItems[0].tag.cuprum run item modify entity @e[tag=cuprum.rose_gold_sword,limit=1,sort=nearest] weapon.mainhand cuprum:rose_gold
execute if data entity @e[tag=cuprum.rose_gold_sword,limit=1,sort=nearest] HandItems[0].tag.cuprum run give @s copper_ingot
execute unless data entity @e[tag=cuprum.rose_gold_sword,limit=1,sort=nearest] HandItems[0].tag.display.Name run item modify entity @e[tag=cuprum.rose_gold_sword,limit=1,sort=nearest] weapon.mainhand cuprum:rose_gold/sword
