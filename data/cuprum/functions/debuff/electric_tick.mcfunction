...
execute if score #ELEC cupr.val1 matches 0 run tp @e[tag=cupr.electric_marker,sort=nearest,limit=1,distance=..0.5] ~ ~ ~ ~4 ~
execute if score #ELEC cupr.val1 matches 2 run tp @e[tag=cupr.electric_marker,sort=nearest,limit=1,distance=..0.5] ~ ~ ~ ~-4 ~
